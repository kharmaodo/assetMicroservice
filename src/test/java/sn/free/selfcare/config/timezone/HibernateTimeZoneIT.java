package sn.free.selfcare.config.timezone;

import sn.free.selfcare.AssetMicroserviceApp;
import sn.free.selfcare.config.SecurityBeanOverrideConfiguration;
import sn.free.selfcare.repository.timezone.DateTimeWrapper;
import sn.free.selfcare.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM selfcare_date_time_wrapper where id=%d", fieldName, id);
    }
